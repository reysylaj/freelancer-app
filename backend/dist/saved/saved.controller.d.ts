...
export declare class SavedController {
    ...
    saveJob(req: RequestWithUser, body: SaveItemDto): Promise<import("./saved-job.entity").SavedJob>;
    saveProject(req: RequestWithUser, body: SaveItemDto): Promise<import("./saved-project.entity").SavedProject>;
